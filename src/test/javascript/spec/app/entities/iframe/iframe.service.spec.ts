...
import { IIframe, Iframe } from 'app/shared/model/iframe.model';
...
describe('Service Tests', () => {
    describe('Iframe Service', () => {
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Iframe', async () => {
            ...
            it('should delete a Iframe', async () => {
