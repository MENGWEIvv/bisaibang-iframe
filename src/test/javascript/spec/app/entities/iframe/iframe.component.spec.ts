    ...
    describe('Iframe Management Component', () => {
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(IframeComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.iframes[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
